...
#ifndef POLY_2B_MBNRG_A1B3C1D2E1F1G1H1_I1J2X2_DEG3_H
#define POLY_2B_MBNRG_A1B3C1D2E1F1G1H1_I1J2X2_DEG3_H

/**
 * @file poly_2b_A1B3C1D2E1F1G1H1_I1J2X2_deg3_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1B3C1D2E1F1G1H1_I1J2X2
 */
...
struct poly_A1B3C1D2E1F1G1H1_I1J2X2_deg3_v1 {
    // Degree of the polynomial
    static const unsigned degree = 3;

    // Number of variables
    static const unsigned n_vars = 113;

    // Number of terms
    static const unsigned size = 3534;

    /**
     * @brief Evaluates the polynomial of degree 3 for A1B3C1D2E1F1G1H1_I1J2X2 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables, 
     * evaluates the polynomial for the A1B3C1D2E1F1G1H1_I1J2X2 symmetry.
     * @param[in] x Double array of length 113 with the variable values
     * @param[in] a Double array of 3534 elements with the linear parameters of the polynomial
     * @return Value of the polynomial
     */
    double eval(const double x[113],
              const double a[3534]);
     ...
     * @return Value of the polynomial
     */
    double eval_direct(const double x[113],
                     const double a[3534]);
     ...
     * @param[in] x Double array of length 113 with the variable values
     * @param[in] a Double array of 3534 elements with the linear parameters of the polynomial
     * @param[out] g Double array of length 113 that will store the gradients dP/dxi
     * @return Value of the polynomial
     */
    double eval(const double x[113],
              const double a[3534],
...
#endif // POLY_2B_MBNRG_A1B3C1D2E1F1G1H1_I1J2X2_DEG3_H
...
//  add_variable['B', '2', 'a', 'I', '1', 'b', 'x-inter-B+I-0']
//  add_variable['B', '2', 'a', 'J', '1', 'b', 'x-inter-B+J-0']
//  add_variable['B', '2', 'a', 'J', '2', 'b', 'x-inter-B+J-0']
//  add_variable['B', '2', 'a', 'X', '1', 'b', 'x-inter-B+X-0']
//  add_variable['B', '2', 'a', 'X', '2', 'b', 'x-inter-B+X-0']
...
//  add_variable['B', '3', 'a', 'I', '1', 'b', 'x-inter-B+I-0']
//  add_variable['B', '3', 'a', 'J', '1', 'b', 'x-inter-B+J-0']
//  add_variable['B', '3', 'a', 'J', '2', 'b', 'x-inter-B+J-0']
//  add_variable['B', '3', 'a', 'X', '1', 'b', 'x-inter-B+X-0']
//  add_variable['B', '3', 'a', 'X', '2', 'b', 'x-inter-B+X-0']
...
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-intra-*+*-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-C+I-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-C+J-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-D+I-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-D+J-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-E+I-*', '1+']
//  add_filter['sum-degree', '*', '3', 'and', 'sum-degree', 'x-inter-E+J-*', '1+']
